...
for episode in range(total_episode):
    ...
    while not Done:
        ...
        update_next_action = greedy(next_state)
        update_next_Q = Q[next_state[0], next_state[1], update_next_action].copy()
        Q[current_state[0], current_state[1], current_action] = (current_Q + learning_rate*(reward + discount_factor*(update_next_Q)-current_Q)).copy()
