...
import GAN.AI2018.WGAN.WGAN_model as model
...
parser.add_argument('--netG', default='/home/leejeyeol/Git/LJY_Machine_Learning/GAN/AI2018/WGAN/output/netG_epoch_60.pth', help="path of Generator networks.(to continue training)")
parser.add_argument('--outf', default='/media/leejeyeol/74B8D3C8B8D38750/Data/AI2018_results/WGAN', help="folder to output images and model checkpoints")
