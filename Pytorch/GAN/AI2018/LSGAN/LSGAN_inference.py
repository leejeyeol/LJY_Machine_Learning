...
parser.add_argument('--netG', default='/home/leejeyeol/Git/LJY_Machine_Learning/GAN/AI2018/LSGAN/output/netG_epoch_130.pth', help="path of Generator networks.(to continue training)")
parser.add_argument('--outf', default='/media/leejeyeol/74B8D3C8B8D38750/Data/AI2018_results/LSGAN', help="folder to output images and model checkpoints")
...
# save directory make   ================================================================================================
try:
    os.makedirs(os.path.join(options.outf,))
