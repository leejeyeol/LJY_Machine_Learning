...
if options.preset == 'None':
    ...
    recon_learn = False
    options.intergrationType = 'GANonly'
...
if __name__ == "__main__" :
    if options.runfunc == 'Train':
        ...
        if options.GAMpretrainedEpoch != 0:
            ...
            alpha_ep = [4, 5, 8, 10, 13, 15, 16, 19, 21, 23, 24, 25, 28, 29, 30, 31, 32, 33, 34, 35, 36, 39, 40, 41, 43, 44, 51, 54, 55, 57, 59, 61, 66, 69, 72, 74, 75, 76, 78, 79, 82, 83, 85, 86, 87, 90, 92, 93, 94, 97, 99, 103, 104, 105, 106, 107, 109, 110, 111, 112, 113, 118, 119, 120, 122, 131]
            ours_ep = [84, 13, 74, 57, 75, 57, 21, 54, 11, 16, 57, 106, 100, 97, 47, 57, 63, 47, 37, 123, 24, 57, 123, 28, 78, 64, 93, 100, 73, 75, 40, 73, 23, 35, 34, 54, 123, 35, 24, 14, 24, 73, 43, 41, 77, 106, 118, 21, 106, 49, 47, 43, 63, 22, 118, 123, 74, 21, 23, 13, 63, 22, 17, 84, 63, 15]
            for i in range(len(alpha_ep)):
                options.pretrainedEpoch = alpha_ep[i]
