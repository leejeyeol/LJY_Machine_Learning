...
import GAN.AI2018.EBGAN.EBGAN_model as model
...
parser.add_argument('--netG', default='/home/leejeyeol/Git/LJY_Machine_Learning/GAN/AI2018/EBGAN/output/netG_epoch_4.pth', help="path of Generator networks.(to continue training)")
...
parser.add_argument('--outf', default='/media/leejeyeol/74B8D3C8B8D38750/Data/AI2018_results/EBGAN', help="folder to output images and model checkpoints")
...
parser.add_argument('--margin', type=int, default=80, help='margin of the energy loss')
...
for epoch in range(options.iteration):
    ...
    if display:
        win_dict = LJY_visualize_tools.draw_images_to_windict(win_dict, [testImage], ["EBGAN_%s" % dataset])
